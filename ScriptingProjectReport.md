...
One minor takeaway was the necesscitry of regularly checking scripts to ensure that they remain functional thorughout the project. We found that dependencies and system environments changed unexpectedly leading to errors within the scripts. For instance, our initial script worked as intended, but somewhere within the two week period a critical resource it relied on changed across systems, rendering it ineffective. This highlighted the importance of routine validation and adaptability in automation—without periodic checks, even a well-designed script can fail due to shifting system configurations or missing dependencies.
